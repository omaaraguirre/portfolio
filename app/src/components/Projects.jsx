...
const Projects = () => {
  return (
    <section className='montserrat flex flex-col items-center py-14 mt-20 max-w-xl min-[900px]:max-w-5xl mx-auto'>
